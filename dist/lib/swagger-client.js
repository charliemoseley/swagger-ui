...
Operation.prototype.execute = function(arg1, arg2, arg3, arg4, parent) {
  ...
  if(opts['sendToApiScience']) {
    ...
    parsedUrl   = urlObject({ url : url});
    monitorName = this.method.toUpperCase() + " " + parsedUrl.pathname;
    ...
    obj.method = "POST";
    obj.url = "https://api.apiscience.com/v1/monitors";
    obj.body = JSON.stringify(monitor);
    obj.headers = headers;
  }
